...
extern_module_init(alsa_card_als4k_init)
extern_module_exit(alsa_card_als4k_exit)
...
extern_module_init(alsa_card_via686a_init)
extern_module_exit(alsa_card_via686a_exit)
extern_module_init(alsa_card_via8233_init)
extern_module_exit(alsa_card_via8233_exit)
