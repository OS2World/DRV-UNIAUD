; $Id: startup.asm,v 1.20 2002/05/03 15:42:44 sandervl Exp $ 
;*
...
;*********************************************************************************************
help_header     dw OFFSET DATA16:sblive_header         ; Pointer to next driver
...
;                  +--------------------------------- char/block device driver
                ...
                dw offset CODE16:sblive_stub_idc      ; IDC routine entry point
...
RMNodeData16     DB MAXSIZE_RMNodeData     dup (0)
RMResources16    DB MAXSIZE_RMResources    dup (0)
RMHandleList16   DB MAXSIZE_RMHandleList   dup (0)
RMResourceList16 DB MAXSIZE_RMResourceList dup (0)
ENDIF
...
IFNDEF MANUAL_PCI_DETECTION
    public  _RMNodeData
    public  _RMResources
    public  _RMHandleList
    public  _RMResourceList
ENDIF    
...
;16:16 addresses of data used by our resource manager class
    _RMNodeData      dw OFFSET  DATA16:RMNodeData16
		     dw SEG     DATA16:RMNodeData16

    _RMResources     dw OFFSET  DATA16:RMResources16
		     dw SEG     DATA16:RMResources16

    _RMHandleList    dw OFFSET  DATA16:RMHandleList16
		     dw SEG     DATA16:RMHandleList16

    _RMResourceList  dw OFFSET  DATA16:RMResourceList16
		     dw SEG     DATA16:RMResourceList16
ENDIF
