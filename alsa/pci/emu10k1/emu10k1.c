...
#ifdef TARGET_OS2
static int snd_extin[SNDRV_CARDS] = {0,0,0,0,0,0,0,0};
static int snd_extout[SNDRV_CARDS] = {0,0,0,0,0,0,0,0};
static int snd_seq_ports[SNDRV_CARDS] = {4,4,4,4,4,4,4,4};
static int snd_max_synth_voices[SNDRV_CARDS] = {64,64,64,64,64,64,64,64};
static int snd_max_buffer_size[SNDRV_CARDS] = {128,128,128,128,128,128,128,128};
static int snd_enable_ir[SNDRV_CARDS] = {0,0,0,0,0,0,0,0};
#else
