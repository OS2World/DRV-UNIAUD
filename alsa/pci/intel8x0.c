...
#ifdef TARGET_OS2
static int snd_ac97_clock[SNDRV_CARDS] = {REPEAT_SNDRV(0)};
#else
...
static snd_pcm_ops_t snd_intel8x0_playback_ops = {
	...
	snd_intel8x0_playback_pointer,0,0
};
...
static snd_pcm_ops_t snd_intel8x0_capture_ops = {
	...
	snd_intel8x0_capture_pointer,0,0
};
#else
static snd_pcm_ops_t snd_intel8x0_playback_ops = {
...
static snd_pcm_ops_t snd_intel8x0_capture_mic_ops = {
	snd_intel8x0_capture_mic_open,
	snd_intel8x0_capture_mic_close,
	snd_intel8x0_capture_mic_ioctl,
	snd_intel8x0_hw_params,
	snd_intel8x0_hw_free,
	snd_intel8x0_capture_mic_prepare,
	snd_intel8x0_capture_mic_trigger,
	snd_intel8x0_capture_mic_pointer,0,0
};
#else
static snd_pcm_ops_t snd_intel8x0_capture_mic_ops = {
...
#ifdef TARGET_OS2
    //time measuring too unreliable right now; assume ac97 clock is fine
    return;
#endif
